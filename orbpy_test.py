...
(pos0,vel0) = op.orb2eci(SMA, ecc, inc, RAAN, arg_per, true_anom, mu)
...
for i in range(1,np.size(t)):
	(pos_next, vel_next) = op.twobody_prop(pos0, vel0, t[i], mu)
	pos[i,] = pos_next
	vel[i,] = vel_next
...
DUT1 = 0
DAT = 0
R = op.eci2ecef(UTC, xp, yp, DUT1, DAT, nutation_series)
print(R)
